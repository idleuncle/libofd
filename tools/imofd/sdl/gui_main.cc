...
// Defined in gui_main.cc
extern cairo_surface_t *create_cairo_surface_from_sdl_surface(SDL_Surface *sdl_surface);//{
...
bool SDLApp::init(){
    ...
    m_screenRenderer = SDL_CreateRenderer(m_mainWindow, -2, SDL_RENDERER_ACCELERATED);// | SDL_RENDERER_PRESENTVSYNC);
